...
public class Multa_Controller extends Controllers{
    ...
    public void traer(int V) {
        switch (V) {
            case 1:
                multaresult = Mmulta.ConsultarMes((Calendar.getInstance().get(Calendar.MONTH) + 1), Calendar.getInstance().get(Calendar.YEAR), "and tmulDescripcion like '" + VistaMulta.jTextField3.getText() + "%' and tmulValor like '" + VistaMulta.jTextField4.getText() + "%'");
                break;
            case 2:
                multaresult = Mmulta.findAll(TMulta.class, "tmulDescripcion like '" + VistaMulta.jTextField3.getText() + "%' and tmulValor like '" + VistaMulta.jTextField4.getText() + "%'");
                break;
            case 3:
                if (VistaMulta.Comp_Fecha_Desde1.getDate() != null && VistaMulta.Comp_Fecha_Desde2.getDate() != null) {
                    ...
                    multaresult = Mmulta.ConsultarPorFechas(fecha1, fecha2, "and tmulDescripcion like '" + VistaMulta.jTextField3.getText() + "%' and tmulValor like '" + VistaMulta.jTextField4.getText() + "%'");
                } else {
    ...
    public boolean aceptar(){
        String cc = Multa_Ui.a_cedula.getText();
